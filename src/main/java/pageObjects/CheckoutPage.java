...
public class CheckoutPage {
   ...
   // @FindBy(how = How.CSS, using = "#billing_state_field .select2-arrow")
    ...
    @FindAll(@FindBy(how = How.XPATH, using = "//select[@name='billing_country']/option"))
    private List<WebElement> country_List;
    
    @FindAll(@FindBy(how = How.XPATH, using = "//select[@name='billing_state']/option"))
    private List<WebElement> state_List;
    
    @FindAll(@FindBy(how = How.XPATH, using = "//select[@name='billing_state']"))
    ...
    public void select_County(String stateName) {
